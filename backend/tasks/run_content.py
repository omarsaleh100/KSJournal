#!/usr/bin/env python3
"""
KSJournal Content Publisher
Generates all editorial content (everything except market ticker and newsletter).
Runs early morning so content is ready before markets open.
Usage: python tasks/run_content.py
"""
import subprocess
import sys
import os
...
def run_all():
    print(f"{'='*60}")
    print(f"  THE KEELE STREET JOURNAL - Content Generation")
